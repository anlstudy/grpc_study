...
var file_demo_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x23, 0x0a, 0x0d, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x52, 0x65, 0x71,
	...
	0x61, 0x6c, 0x75, 0x65, 0x22, 0x23, 0x0a, 0x0d, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x33, 0x0a, 0x0e, 0x53, 0x74, 0x72,
	0x65, 0x61, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x21, 0x0a, 0x0c, 0x73,
	0x74, 0x72, 0x65, 0x61, 0x6d, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x0b, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x32, 0x80,
	0x02, 0x0a, 0x06, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x12, 0x36, 0x0a, 0x05, 0x52, 0x6f, 0x75,
	...
	0x3c, 0x0a, 0x09, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x14, 0x2e, 0x70,
	...
	0x0d, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x14,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x15, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x53, 0x74, 0x72,
...
var file_demo_proto_depIdxs = []int32{
	...
	2, // 1: proto.Simple.ListValue:input_type -> proto.StreamRequest
	0, // 2: proto.Simple.RouteList:input_type -> proto.SimpleRequest
	2, // 3: proto.Simple.Conversations:input_type -> proto.StreamRequest
	1, // 4: proto.Simple.Route:output_type -> proto.SimpleResponse
	3, // 5: proto.Simple.ListValue:output_type -> proto.StreamResponse
	1, // 6: proto.Simple.RouteList:output_type -> proto.SimpleResponse
	3, // 7: proto.Simple.Conversations:output_type -> proto.StreamResponse
...
type SimpleClient interface {
	...
	ListValue(ctx context.Context, in *StreamRequest, opts ...grpc.CallOption) (Simple_ListValueClient, error)
	// 客户端流式rpc, 在发送数据前添加stream
	RouteList(ctx context.Context, opts ...grpc.CallOption) (Simple_RouteListClient, error)
	// 双向流式rpc
...
func (c *simpleClient) ListValue(ctx context.Context, in *StreamRequest, opts ...grpc.CallOption) (Simple_ListValueClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Simple_serviceDesc.Streams[0], "/proto.Simple/ListValue", opts...)
	if err != nil {
		return nil, err
	}
	x := &simpleListValueClient{stream}
...
type Simple_ListValueClient interface {
	Recv() (*StreamResponse, error)
	grpc.ClientStream
}

type simpleListValueClient struct {
	grpc.ClientStream
}

func (x *simpleListValueClient) Recv() (*StreamResponse, error) {
...
func (c *simpleClient) RouteList(ctx context.Context, opts ...grpc.CallOption) (Simple_RouteListClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Simple_serviceDesc.Streams[1], "/proto.Simple/RouteList", opts...)
	if err != nil {
		return nil, err
	}
	x := &simpleRouteListClient{stream}
	return x, nil
}

type Simple_RouteListClient interface {
	Send(*SimpleRequest) error
	CloseAndRecv() (*SimpleResponse, error)
	grpc.ClientStream
}

type simpleRouteListClient struct {
	grpc.ClientStream
}

func (x *simpleRouteListClient) Send(m *SimpleRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *simpleRouteListClient) CloseAndRecv() (*SimpleResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
...
func (c *simpleClient) Conversations(ctx context.Context, opts ...grpc.CallOption) (Simple_ConversationsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Simple_serviceDesc.Streams[2], "/proto.Simple/Conversations", opts...)
	if err != nil {
		return nil, err
	}
...
type SimpleServer interface {
	...
	// 服务端流式rpc，在响应数据前添加stream
	ListValue(*StreamRequest, Simple_ListValueServer) error
	// 客户端流式rpc, 在发送数据前添加stream
	RouteList(Simple_RouteListServer) error
	// 双向流式rpc
...
func (*UnimplementedSimpleServer) ListValue(*StreamRequest, Simple_ListValueServer) error {
	return status.Errorf(codes.Unimplemented, "method ListValue not implemented")
}
func (*UnimplementedSimpleServer) RouteList(Simple_RouteListServer) error {
...
func _Simple_ListValue_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(StreamRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(SimpleServer).ListValue(m, &simpleListValueServer{stream})
}

type Simple_ListValueServer interface {
	Send(*StreamResponse) error
	grpc.ServerStream
}

type simpleListValueServer struct {
	grpc.ServerStream
}

func (x *simpleListValueServer) Send(m *StreamResponse) error {
	return x.ServerStream.SendMsg(m)
}

func _Simple_RouteList_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(SimpleServer).RouteList(&simpleRouteListServer{stream})
}

type Simple_RouteListServer interface {
	SendAndClose(*SimpleResponse) error
	Recv() (*SimpleRequest, error)
	grpc.ServerStream
}

type simpleRouteListServer struct {
	grpc.ServerStream
}

func (x *simpleRouteListServer) SendAndClose(m *SimpleResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *simpleRouteListServer) Recv() (*SimpleRequest, error) {
	m := new(SimpleRequest)
	...
	Streams: []grpc.StreamDesc{
		{
			...
			Handler:       _Simple_ListValue_Handler,
			ServerStreams: true,
		},
		{
			StreamName:    "RouteList",
			Handler:       _Simple_RouteList_Handler,
			ClientStreams: true,
		},
		{
